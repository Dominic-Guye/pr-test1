...
def get_positive_integer_input(question_string):
    """It keeps asking the user for input until they either respond with an integer or quit.
    It returns None if the user quits, otherwise it returns the integer.
    """
    # Ask user for input
